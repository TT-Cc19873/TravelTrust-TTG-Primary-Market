...
- **04** 干什么：只分已抽出的平台费（现在默认 5%）
- 平台费 5%（500 bps）— 仅治理可改
- 有活跃主理人：平台费的 45% 至主理人钱包；55% 至 **05 项目美元池** `0x65714bbF2f3B8bB7E4c71F5D51C0bbe6869dAB68`
- 无主理人：100% 至 05
- 公售 USDC → **06 柜台 → 05 池**（**永不**进入 Legacy P4Cap / 旧池 `0x7B21…`）
- **10 主理人席位**：主理人用 TTG 占席；30 万打 **14**、币锁本台（不是 08）
- **08** 是下一台分账（针未切），不是现在的 04
